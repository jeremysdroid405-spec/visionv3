# Hardcoded Collection-Name References (Wave 0 scan)

Generated: 2026-04-19T06:18:14Z

Total references: 429 across 115 files.
...
| `backend/config/collections.py` | 98 | dg_live_props | `"live_props":              "dg_live_props",` |
| `backend/config/collections.py` | 99 | dg_cached_board | `"cached_board":             "dg_cached_board",` |
| `backend/config/collections.py` | 104 | dg_events_cache | `"events_cache":             "dg_events_cache",` |
| `backend/config/collections.py` | 105 | dg_odds_cache | `"odds_cache":               "dg_odds_cache",` |
| `backend/config/collections.py` | 107 | dg_master_roster | `"master_roster":            "dg_master_roster",` |
| `backend/config/collections.py` | 108 | dg_player_stats | `"player_stats":             "dg_player_stats",` |
...
| `backend/db/collections.py` | 44 | nba_master_hub_2026 | `MASTER_HUB = "nba_master_hub_2026"` |
| `backend/db/collections.py` | 47 | dg_master_roster | `MASTER_ROSTER = "dg_master_roster"` |
| `backend/db/collections.py` | 63 | dg_cached_board | `CACHED_BOARD = "dg_cached_board"` |
| `backend/db/collections.py` | 66 | dg_live_props | `LIVE_PROPS = "dg_live_props"` |
| `backend/db/collections.py` | 84 | nba_context_engine | `CONTEXT_ENGINE = "nba_context_engine"` |
| `backend/db/collections.py` | 87 | nba_career_stats | `CAREER_STATS = "nba_career_stats"` |
| `backend/db/collections.py` | 100 | dg_odds_cache | `ODDS_CACHE = "dg_odds_cache"` |
| `backend/db/collections.py` | 103 | dg_events_cache | `EVENTS_CACHE = "dg_events_cache"` |
| `backend/db/collections.py` | 128 | dg_sync_log | `SYNC_LOG = "dg_sync_log"` |
...
| `backend/routes/cached_data.py` | 315 | dg_cached_board | `async for doc in engine.db.dg_cached_board.aggregate(pipeline):` |
| `backend/routes/cached_data.py` | 319 | dg_cached_board | `latest = await engine.db.dg_cached_board.find_one(` |
| `backend/routes/cached_data.py` | 553 | nba_context_engine | `context_engine = db['nba_context_engine']` |
| `backend/routes/cached_data.py` | 940 | nba_master_hub_2026 | `master_hub = db.nba_master_hub_2026` |
| `backend/routes/cached_data.py` | 963 | dg_cached_board | `raw_doc = await db.dg_cached_board.find_one(` |
| `backend/routes/cached_data.py` | 1037 | dg_cached_board | `cached_player = await db.dg_cached_board.find_one(` |
...
| `backend/services/context_badge_service.py` | 143 | nba_master_hub_2026 | `self.master_hub = db.nba_master_hub_2026` |
| `backend/services/context_badge_service.py` | 144 | dg_cached_board | `self.cached_board = db.dg_cached_board` |
...
| `backend/services/defensive_momentum_service.py` | 192 | defensive_momentum_cache | `self.momentum_cache = db.defensive_momentum_cache` |
...
| `backend/services/nba_career_service.py` | 147 | nba_career_stats | `collection = db['nba_career_stats']` |
...
| `backend/services/vegas_killer_model.py` | 172 | defensive_momentum_cache | `for doc in self.db['defensive_momentum_cache'].find({}):` |
| `backend/services/vegas_killer_model.py` | 1187 | nba_master_hub_2026 | `hub = self.db['nba_master_hub_2026']` |
| `backend/services/vegas_killer_model.py` | 1695 | nba_master_hub_2026 | `hub = self.db['nba_master_hub_2026']` |
| `backend/services/vegas_pro_model.py` | 12 | nba_master_hub_2026 | `1. EXTRACT: Pull game logs from nba_master_hub_2026` |
| `backend/services/vegas_pro_model.py` | 101 | defensive_momentum_cache | `cursor = self.db['defensive_momentum_cache'].find({})` |
| `backend/services/vegas_pro_model.py` | 155 | nba_master_hub_2026 | `hub = self.db['nba_master_hub_2026']` |
| `backend/services/vegas_pro_model.py` | 560 | nba_master_hub_2026 | `hub = self.db['nba_master_hub_2026']` |
...
| `backend/services/vegas_regression_model.py` | 96 | defensive_momentum_cache | `cursor = self.db['defensive_momentum_cache'].find({})` |
| `backend/services/vegas_regression_model.py` | 595 | nba_master_hub_2026 | `hub = db['nba_master_hub_2026']` |

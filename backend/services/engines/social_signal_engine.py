...
class SocialSignalEngine:
    ...
    async def sync_social_signals(self, player_names: List[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if player_names:
                ...
                cursor = self.db.dg_cached_board.find({}, {"player_name": 1})
    ...
    async def _check_player_signals(self, player_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            hub_player = await self.db.nba_master_hub_2026.find_one({
            ...
            board_player = await self.db.dg_cached_board.find_one({
                "player_name": player_name
            })

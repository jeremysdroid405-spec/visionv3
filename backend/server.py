...
@api_router.get("/v3/odds-mapper/lookup/{odds_api_name}")
...
@api_router.post("/v3/odds-mapper/lookup-batch")
...
@api_router.post("/v3/odds-mapper/rebuild")
...
@api_router.get("/v3/odds-mapper/player-id/{player_id}")
